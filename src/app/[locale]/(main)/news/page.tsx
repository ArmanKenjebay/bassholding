...
export default async function News({
    ...
    params: { locale: Locale, }, searchParams: { [key: string]: string | string[] }
}) {
        ...
        <section className="flex flex-col w-full h-full">
            <PageWrapper>
              ...
              <span>
                ...
                <div
                    className="xl:px-[60px] flex flex-col sm:flex-row justify-between gap-x-5 gap-y-10 px-5 sm:mb-10 mb-5">
                    {locale && (<NewsPreviews locale={locale} searchParams={searchParams}/>)}

                    <div
                        className="flex flex-1 flex-col bg-[#272727] h-fit p-10 rounded-3xl overflow-y-auto scrollbar-hide">
