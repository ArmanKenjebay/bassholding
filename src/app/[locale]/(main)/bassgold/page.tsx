      ...
      <PageWrapper>
        <div className="relative w-full h-full flex sm:mb-10 mb-5">
          ...
          <div className="px-5 xl:pl-[60px] xl:pb-[67px] z-10 absolute h-full flex flex-col justify-end">
            ...
            <span className="opacity-95 xl:text-[32px] text-xs leading-tight font-[300] mb-5">
        ...
        <div className="xl:px-[60px] relative z-50 sm:px-5 px-5 flex flex-col gap-3 xl:gap-x-[40px] md:flex-row sm:mb-10 mb-5">
          <div className="flex flex-1 flex-col p-5 xl:px-[40px] xl:py-[55px] rounded-3xl bg-[#0E0D0D]">
            <span className="text-primary-gold xl:text-[24px] xl:mb-[50px]">
              {dictionary.direction['ushshoky_title']}
            </span>
            <span className="text-sm xl:text-[20px] leading-normal font-[300] xl:mb-10 mb-3">
              {dictionary.direction['ushshoky_text-1']}
            </span>

            <span
              className={`text-sm xl:text-[20px] leading-normal font-[300] xl:mb-10 mb-3`}
            >
              {dictionary.direction['ushshoky_text-2']}
            </span>

            <ul className="list-disc text-sm xl:text-[20px] leading-normal font-[300] px-5">
          ...
          <div className="flex flex-1 flex-col p-5 xl:px-[40px] xl:py-[55px] rounded-3xl bg-[#0E0D0D]">
            <span className="text-primary-gold tracking-widest xl:text-[24px] xl:mb-[50px]">
              {dictionary.direction.chinasyl_say_title}
            </span>
            <span className="text-sm xl:text-[20px] leading-normal font-[300] mb-3">
